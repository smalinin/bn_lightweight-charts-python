...
class Candlestick(SeriesCommon):
    ...
    def set(self, df: Optional[pd.DataFrame] = None, keep_drawings=False, draw_data=True):
        """
...
class AbstractChart(Candlestick, Pane):
    ...
    def create_line(
        ...
        """
        line = Line(self, name, color, style, width, price_line, price_label, price_scale_id)
    ...
    def create_histogram(
        ...
        """
        hist = Histogram(self, name, color, price_line, price_label, scale_margin_top, scale_margin_bottom)
        return hist
