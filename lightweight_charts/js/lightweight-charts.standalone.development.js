/*!
 * @license
 * TradingView Lightweight Charts™ v4.2.3-dev+202412032152
        ...
        _private__adjustSizeImpl() {
            ...
            for (const paneWidget of this._private__paneWidgets) {
                if (this._private__isLeftAxisVisible()) {
                    ...
                    if (this._private__options.leftPriceScale.permWidth > 0)
                        leftPriceAxisWidth = this._private__options.leftPriceScale.permWidth;
                }
                if (this._private__isRightAxisVisible()) {
                    ...
                    if (this._private__options.rightPriceScale.permWidth > 0)
                        rightPriceAxisWidth = this._private__options.rightPriceScale.permWidth;
                }
